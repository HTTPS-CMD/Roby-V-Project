...
return [
    ...
    'unique_in' => ':Attribute قبلا در :table استفاده شده است.',
    ...
    'attributes' => [
        ...
        'late' => 'نام مرحوم / مرحومه',
        'type' => 'نوع',
        'status' => 'وضعیت',
        'late_gender' => 'جنسیت مرحوم / مرحومه',
        'lesson' => 'درس',
        'location' => 'نقشه',
        'line_address_1' => 'آدرس 1',
        'line_address_2' => 'آدرس 2',
        'material_id' => 'نوع صندوق',
        'message' => 'پیام',
        'middle_name' => 'نام وسط',
        'minute' => 'دقیقه',
        'mobile' => 'شماره همراه',
        ...
        'number' => 'شماره',
        'created_by' => 'کاربر',
        'needy_id' => 'شناسه مددجو',
        'needy_name' => 'نام و نام خانوادگی مددجو',
        'needy_phone' => 'تلفن ثابت / شماره موبایل مددجو',
        'needy_address' => 'نشانی - آدرس مددجو',
        'password' => 'رمز عبور',
